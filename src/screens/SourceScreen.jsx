...
const SourceScreen = () => {
  ...
  const handleNext = (event) => {
    ...
    const TYPE =
      selectedValue === "sql" || selectedValue === "csv"
        ? "structured"
        : "unstructured";
    dispatch({
      type: "SOURCE",
      payload: { source: selectedValue, type: TYPE },
    });
    ...
    <>
      <div className="container main-content">
        <div className="d-flex flex-column ms-5 mb-3">
          <p className="fs-5 fw-normal my-4 content-color">
            Select the data source from which you want to generate LLM model.
          </p>
        ...
        <div className="d-flex justify-content-end">
          <Button disabled={selectedValue.length === 0} onClick={handleNext}>
            Next
          </Button>
        </div>
      </div>
